<template>
  <div class="row set-head">
    ...
    <div class="col-6 breadcrumb justify-content-end">
      ...
      <router-link to="dataposyandu" class="to-ds">Data Kader</router-link>
    </div>
  </div>
  <div class="bs-wrapp p-0">
    <PATabsWrapp>
      <PATabs title="Aktif">
        <div class="p-3">
          <div class="wrapp-btn">
            ...
            <div class="btn-kanan">
              <button class="btn-c b-import" @click="callModalImport">Import <img src="../../../assets/img/i-import.png"
                  alt=""></button>
              <router-link to="tambahdataposyandu" class="btn-c unduh"><img src="../../../assets/img/i-tambah.png"
                  alt=""> Tambah
              </router-link>
            </div>
          </div>
          ...
          <table id="myTable" class="display table table-striped" style="width:100%">
            <thead>
              <tr>
                ...
                <th rowspan="2" style="vertical-align : middle;">Nama Posyandu</th>
                <th rowspan="2" style="vertical-align : middle;">PIC</th>
                <th rowspan="2" style="vertical-align : middle;">No. HP PIC</th>
                <th rowspan="2" style="vertical-align : middle;">Kecamatan</th>
                <th colspan="2" class="text-center">kordinat Lokasi</th>
              ...
              <tr>
                ...
                <td>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end p-3">
                    <li>
                      <router-link to="detaildataposyandu"><img src="../../../assets/img/i-eye.png" alt=""> Detail
                      </router-link>
                    </li>
                    <li>
                      <router-link to="editdataposyandu"><img src="../../../assets/img/i-edit.png" alt=""> Edit
                      </router-link>
                    </li>
                  </ul>
                </td>
...
<script setup>
import PATabsWrapp from '../../../components/tab/tab0/PATabsWrapp.vue'
import PATabs from '../../../components/tab/tab0/PATabs.vue'
